...
xCent = [xCent1,xCent2,xCent3,xCent4,xCent5,xCent6]
yCent = [yCent1,yCent2,yCent3,yCent4,yCent5,yCent6]
Cent = [xCent,yCent]
newCent = []
l = 1
...
while (Cent != newCent):
    ...
    for i in range(0,688):
        ...
        # menentukan data lebih dekat dengan centroid 1, 2, 3, 4, 5 atau 6
        if (clust1 <= clust2):
            if (clust1 <= clust3):
                if (clust1 <= clust4):
                    if (clust1 <= clust5):
